...
2. Replace "YOUR_WIFI_SSID" with your Wi-Fi network name (SSID) and "YOUR_WIFI_PASSWORD" with your Wi-Fi password in `client/nodemcu/nodemcu.ino`.
3. Create a Discord bot and obtain its token. Add the token by filling in the appropriate field in `server/discord_bot.py`.
