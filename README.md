...
3. Create a Discord bot and obtain its token in [Discord Portal](https://discord.com/developers/applications). Add the token by filling in the appropriate field in `server/discord_bot.py`.
